...
$codeBuddyHookUrl = $hookUrl -replace "/claude-hook$", "/codebuddy-hook"
...
try {
  ...
  Invoke-RestMethod -Uri $codeBuddyHookUrl -Method Post -Body $bodyBytes -ContentType "application/json; charset=utf-8" -TimeoutSec 2 | Out-Null
} catch {
