...
$qoderHookUrl = $hookUrl -replace "/claude-hook$", "/qoder-hook"
...
try {
  ...
  Invoke-RestMethod -Uri $qoderHookUrl -Method Post -Body $bodyBytes -ContentType "application/json; charset=utf-8" -TimeoutSec 2 | Out-Null
} catch {
